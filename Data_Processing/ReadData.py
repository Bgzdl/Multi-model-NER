...
class PrimmedCustomDataset(Dataset):
    @staticmethod
...
if __name__ == "__main__":
    # training set
    A = PrimmedCustomDataset('../IJCAI2019_data', 'train')
    for i in range(7123):
        A[i]
    # validation set
    B = CustomDataset('../IJCAI2019_data', 'valid')
    for i in range(1665):
        B[i]
    # test set
    C = CustomDataset('../IJCAI2019_data', 'test')
    for i in range(3930):
        C[i]
